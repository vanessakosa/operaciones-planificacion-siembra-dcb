...
def main(argv):
    ...
    print("    2. Los tallos cortan el %s. Todo lote abierto en esa" % ofe["corte"])
    print("       fecha sale SUBESTIMADO — y con el su $/m2/sem.")
    print("    3. EL ORDEN ES SENSIBLE AL LARGO DEL REGISTRO, y no poco. Al")
    print("       entrar las semanas ISO 33-35 (2026-09-10), Lisianthus paso de")
    print("       $78.474 a $17.749 y de primero a cuarto: la ventana mas larga")
    print("       le solapo 11.400 plantas en vez de 2.106, y esas camas nuevas")
    print("       casi no aportaron tallos. Un cultivo de ocupacion larga y")
    print("       ventana corta es el mas expuesto a esto. Mientras falten")
    print("       semanas por registrar, este orden es provisional.")
    print("    4. El %.0f%% de las plantas sigue sin semana de trasplante, y el"
          % (100 * (1 - cob["pct"])))
