...
| Producto | Stock | Función |
|---|---|---|
| **Raxter Mix SC** (Metarhizium + Beauveria + Bt kurstaki + **Bacillus popilliae**) | **0** — llegaron 2 kg el 2026-09-23 y se aplicaron COMPLETOS ese día (drench bocas 3B+4A+4B, 2.000 L en el tanque para 4A+4B + 200 L en caneca para 3B, a 1 cc/L). **Sin repetición: Vanessa decidió cerrar el tratamiento con esta aplicación** (ya hubo Metarhizium la sem 38) | **CHIZA por drench — 50 cc/cama, repetir a los 15 días.** Ficha FT8030 v2, ICA 14487. **NO mezclar con fungicidas ni bactericidas** |
