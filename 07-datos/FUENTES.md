...
| ✅ | `registro_tallos.csv` — **hueco 13→24 ago llenado por dictado** | — | Vanessa dictó por voz 78 filas / 11.457 tallos para el tramo 2026-08-13 → 2026-08-24 que el reexporte de Drive no cubre (corte 12/08). **2026-08-25 sigue sin dato** — no dictado todavía, no inventado. Confianza `alta` en la mayoría; **quedan 6 filas con bloque INFERIDO** (no dictado, tomado del último lote real conocido antes del hueco) marcadas en notas: Statice Mix y Celosia Shimmer Mix en varios días heredan bloque `3b+4c` / `3a` del 11 y 06 de agosto respectivamente — **pedir a Vanessa que lo confirme**. También quedan marcados con nota: 2 filas de Celosia Enda Rose (19 y 20 ago) donde el cultivar se infirió por continuidad de bloque, no fue redictado; 1 fila de Boca de Dragón (16 ago) con cultivar sin confirmar por la propia Vanessa; 1 fila de Strawflower (20 ago, 87 tallos) que ella misma marcó como sospechosa; y el bloque `ext3B` de Strawflower no coincide con su histórico (`Inv6`/`ext6`) — puede ser cama nueva, sin confirmar. **Cuando David/Erica re-exporten el Excel maestro para este mismo tramo, revisar contra estas filas antes de pegar encima — riesgo de duplicado.** |
